...
public class HotelAccount implements Serializable{
	...
	public HotelAccount(AccountPO accountPO , HotelAddressPO hotelAddressPO, HotelBasePO hotelBasePO){
		super();
		this.userName = accountPO.getUsername();
		this.customerID = accountPO.getUserid();
		this.hotelAddress = hotelAddressPO.getAddressDetail();
