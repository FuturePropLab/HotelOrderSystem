...
//			System.out.println(roomDateHelper.deleteRoom("HT001", "301"));
			...
			Date date1 = new Date(2016-1900, 12-1, 14);
			Date date2 = new Date(2016-1900, 12-1, 15);
			Date date3 = new Date(2016-1900, 12-1, 16);
			Date date4 = new Date(2016-1900, 12-1, 17);
			System.out.println(roomDateHelper.deleteRecord("HT001", "301"));
