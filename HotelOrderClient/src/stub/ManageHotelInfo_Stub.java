...
public class ManageHotelInfo_Stub implements ManageHotelInfoService {
	...
	public HotelInfoVO editHotelInfo(String hotel_id) {
		...
		TypeRoomInfo typeRoomInfo1= new TypeRoomInfo("001","荣华大酒店",RoomType.Single,5,180.0);
		typeList.add(typeRoomInfo1);
		HotelRoomInfoVO hotelRoomInfoVO = new HotelRoomInfoVO("001","荣华大酒店",typeList);
		
		HotelInfoVO hotelinfo=new HotelInfoVO("001","荣华大酒店", "nanjing","xinjiekou","good","good","room",hotelRoomInfoVO,Star.five);
